# Generated by Powerlevel10k configuration wizard on 2021-03-10 at 14:16 CET.
...
# dotted, no frame, dark-ornaments, compact, many icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=94
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%5F'  # red foreground
    else

...
--	gears.wallpaper.maximized("path_to_wallpaper", s, false)
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "web", "term", "hdd", "vim", "media", "irc"}, s, 
    {layouts[4],layouts[6],layouts[1],layouts[3],layouts[1],layouts[1]})
end
-- }}}
...
datewidget = lain.widgets.abase({	
    ...
    settings = function()
        ...
        widget:set_markup(markup("#009fff","[") .. markup("#7788af", t_output) .. markup("#545659", " > ") .. markup("#de5e1e", o_it(1)) ..  markup("#009fff"," ] "))
    end
})
...
function(widget, args)
	if args["{state}"] == "Play" then
		music_play:set_image("/home/ordnas/.config/awesome/icons/pause.png")
		...
		music_play:set_image("/home/ordnas/.config/awesome/icons/play.png")
...
for s = 1, screen.count() do
    ...
    right_layout_bot:add(datewidget)
